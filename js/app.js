...
(function () {
  ...
  badge.style.cssText = 'position:fixed;bottom:96px;right:20px;z-index:9000;font-family:"DM Sans",sans-serif;font-size:11px;color:rgba(74,74,68,0.5);pointer-events:none;user-select:none;';
